                    ...
                    <div class="header-action">
                        <ul class="action-list">
                            ...
                            <li class="shopping-cart">
                                <a href="/cart" class="cart-dropdown-btn">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="axil-footer-widget">
                            ...
                            <a href="index.html">
                                <img class="light-logo" src="{{ asset('images/logo/logo.png') }}" alt="Logo Images">
                            </a>
                        </div> -->
                            <div class="inner">
                        ...
                        <div class="axil-footer-widget">
                            ...
                            <div class="inner">
                                ...
                                <div class="download-btn-group">
                                    <div class="qr-code">
                                        <img src="{{ asset('images/others/qr.png') }}" alt="Axilthemes">
                                    </div>
                                    <div class="app-link">
                                        <a href="#">
                                            <img src="{{ asset('images/others/app-store.png') }}" alt="App Store">
                                        </a>
                                        <a href="#">
                                            <img src="{{ asset('images/others/play-store.png') }}" alt="Play Store">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-12">
                        <div class="copyright-right d-flex flex-wrap justify-content-xl-end justify-content-center align-items-center">
                            ...
                            <ul class="payment-icons-bottom quick-link">
                                ...
                                <li><img src="{{ asset('images/icons/cart/cart-2.png') }}" alt="paypal cart"></li>
                                <li><img src="{{ asset('images/icons/cart/cart-5.png') }}" alt="paypal cart"></li>
                            </ul>
                        </div>
                    </div>
                </div>
